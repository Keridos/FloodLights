...
public class IGWHandler {
    ...
    private void initTab() {
        ...
        WikiRegistry.registerBlockAndItemPageEntry(ModBlocks.blockUVLight, "block/UVLight");
        WikiRegistry.registerBlockAndItemPageEntry(ModBlocks.blockGrowLight, "block/GrowLight");
    }
}
