 ...
 */
public class BlockSmallFlourescentFloodlight extends BlockFL implements ITileEntityProvider {

    public BlockSmallFlourescentFloodlight(Material material) {
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block par5) {
        if (!world.isRemote) {
            if (world.isBlockIndirectlyGettingPowered(x, y, z)) {
                ((TileEntitySmallFloodlight) world.getTileEntity(x, y, z)).setActive(true);
            } else if (!world.isBlockIndirectlyGettingPowered(x, y, z)) {
                ((TileEntitySmallFloodlight) world.getTileEntity(x, y, z)).setActive(false);
            }
        }
    }
