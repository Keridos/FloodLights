 ...
 * optional.
 */
public class BaseFLTeslaContainer implements ITeslaConsumer, ITeslaProducer, ITeslaHolder {
     ...
     */
    public BaseFLTeslaContainer(long capacity, long input, long output) {
     ...
     * @param output The maximum rate of power that can be extracted at a time.
     */
    public BaseFLTeslaContainer(long power, long capacity, long input, long output) {
     ...
     */
    public BaseFLTeslaContainer(NBTTagCompound dataTag) {
     ...
     */
    public BaseFLTeslaContainer setCapacity (long capacity) {
     ...
     * @return The instance of the container being updated.
     */
    public BaseFLTeslaContainer setInputRate (long rate) {
     ...
     * @return The instance of the container being updated.
     */
    public BaseFLTeslaContainer setOutputRate (long rate) {
     ...
     * @return The instance of the container being updated.
     */
    public BaseFLTeslaContainer setTransferRate (long rate) {
