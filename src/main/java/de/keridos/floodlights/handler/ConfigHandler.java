...
public class ConfigHandler {
    ...
    public void initConfig(Configuration config) {
        ...
        rangeConeFloodlight = config.getInt("rangeConeFloodlight", "general", 24, 1, 64, "How far should the cone floodlights go (Mind that wide only goes quarter as far as this)? Default:24co    ");
