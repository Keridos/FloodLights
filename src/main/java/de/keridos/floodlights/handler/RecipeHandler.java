...
public class RecipeHandler {
    ...
    public void initRecipes() {
        if (configHandler.electricFloodlight) {
            ...
            GameRegistry.addRecipe(new ItemStack(ModItems.lightbulb, 4), " G ", "GFG", " I ", 'G', new ItemStack(getMinecraftItem("glass_pane"), 1), 'F', new ItemStack(ModItems.glowingFilament, 1), 'I', new ItemStack(getMinecraftItem("iron_ingot"), 1));
